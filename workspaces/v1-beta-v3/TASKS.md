...
- [x] [Compass] Lovable demo score (priority: P0) [source: roadmap step 43]
...
- [x] [Compass] Write Marianne's story for the README — who she was, why the name, what it means for this project (priority: P0) [source: F-480, composer directive]
...
- [x] [Compass] Update getting-started.md with the new name, CLI examples, and story context (priority: P0) [source: F-480]
