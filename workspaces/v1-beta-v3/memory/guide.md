...
Experiential: Ten cadences. The documentation surface is mature — full audit found zero issues. Pattern modernization was the remaining gap: features existed in code and docs but weren't demonstrated in examples. Now every fan-out score teaches the movements: feature by using it. The distinction between "docs that don't lie" and "docs that teach."
