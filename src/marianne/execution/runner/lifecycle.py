...
from marianne.execution.hooks import ConcertContext, HookExecutor
...
class LifecycleMixin:
    ...
    async def _synthesize_batch_outputs(
        ...
        Args:
            ...
            state: Job checkpoint state.
        """
        from marianne.execution.synthesizer import ResultSynthesizer, SynthesisConfig
    ...
    async def _aggregate_to_global_store(self, state: CheckpointState) -> None:
        ...
        from marianne.learning.aggregator import EnhancedPatternAggregator
