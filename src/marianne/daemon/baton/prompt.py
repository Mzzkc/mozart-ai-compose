...
class PromptRenderer:
    ...
    def render(
        ...
        *,
        ...
        # Layer 2.5: Inject technique manifest as a skill-category item.
        # This goes after file-based injections so technique availability
        # appears alongside other skills, and before prompt building so
        # the manifest is included in the assembled prompt.
